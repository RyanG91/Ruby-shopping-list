...
#DEFINE METHOD TO PRINT IT OUT ON THE SCREEN
def print_list(shopping_list)
  table = Terminal::Table.new :title => @list_name, :headings => ['Item', 'Quantity'], :rows => shopping_list["items"]
  puts table
end
...
puts ""
puts "Let's add items to our shopping list. Enter 'done' when finished"
x = "yes"
while x == "yes" do
